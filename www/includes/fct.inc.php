...
function visiteurConnecte() {
    return isset($_SESSION['idVisiteur']); //isset retourne si il y a qqch ds la variable session est ce que la colonne idvisteur a qqch donc est connecte aura true ou false
}

function comptableConnecte() {
    return isset($_SESSION['idComptable']); //isset retourne si il y a qqch ds la variable session est ce que la colonne idvisteur a qqch donc est connecte aura true ou false
}

//appel - nom fonction parentheses ; / declarer - fuction nom fonction accolades
/**
